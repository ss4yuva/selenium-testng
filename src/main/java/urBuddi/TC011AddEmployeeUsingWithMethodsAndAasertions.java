...
public class TC011AddEmployeeUsingWithMethodsAndAasertions {
	...
	public static void main(String[] args) {
		...
		obj.addEmployeeDetails(firstNameRandomText, lastNameRandomText, employeeID, "qa"+randomEmail+"@gmail.com", String roleValue,
				"abcd@"+randomPassword, "28-08-1992", "B.Tech", "Software", "Female", mobileNumber, "O+","QA Lead", salary, "Hyderabad",
				"test58@gmail.com");
	}
	...
	driver.findElement(roleDropdown).click();
		...
		dropdown = driver.findElement(roleDropdown);
//		allDropdown();
/*			List<WebElement> options = dropdown.getOptions();
			random = new Random();
			int randomIndex = random.nextInt(options.size());
			 dropdown.selectByIndex(randomIndex);
			 WebElement roleDropdownValue = dropdown.getFirstSelectedOption();
*/
		}
		...
		public void addEmployeeDetails(String firstNameRandomText, String lastNameRandomText, int employeeIDValue, String emailValue, String roleValue, String passwordValue,
				String dobValue, String qualificationsValue, String departmentValue, String genderValue, int mobileNumberValue, String bloodGroupValue, String designationValue,
			 int salaryValue, String locationValueValue, String reportingValue) {
