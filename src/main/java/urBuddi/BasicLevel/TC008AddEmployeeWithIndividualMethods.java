...
public class TC008AddEmployeeWithIndividualMethods {
	...
	public static void main(String[] args) {
		...
		TC008AddEmployeeWithIndividualMethods obj = new TC008AddEmployeeWithIndividualMethods();
		...
		obj.reporting("test57@gmail.com");
