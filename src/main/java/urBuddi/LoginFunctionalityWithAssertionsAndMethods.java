...
public class LoginFunctionalityWithAssertionsAndMethods {
	...
	public static void main(String[] args) {
		...
		obj.loginWithValidEmailAndInvalidPassword("govardhan.gottemukkula@openskale.com", "Sruthi@123");
		obj.loginWithInvalidEmailAndValidPassword("ss4yuvan@gmail.com", "Govardhan_123");
