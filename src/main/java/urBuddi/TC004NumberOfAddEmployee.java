...
public class TC004NumberOfAddEmployee {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Test Data
		String userNameValue = "govardhan.gottemukkula@openskale.com", passwordValue = "Govardhan_123";
		...
		for (int i = 1; i <= 10; i++) {
			...
			// input fields Data
			String firstName = randomString.toString(), lastName = randomString1.toString(),
					email = "test" + x + "@gmail.com", password = "abcd@" + x, department = "Software",
					designation = "QA Lead", location = "Hyderabad";

			int employeeID = x, mobileNumber = 1234567890, salary = 25000;

			String roleValue = "Employee", qualificationsValue = "B.Tech", genderValue = "Female",
					bloodGroupValue = "O+", reportingValue = "test13@gmail.com";
