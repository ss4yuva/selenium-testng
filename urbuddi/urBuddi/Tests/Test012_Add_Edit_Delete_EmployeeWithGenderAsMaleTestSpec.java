...
import urBuddi.Pages.AddEmployeeWithGenderAsMalePage;
...
public class Test012_Add_Edit_Delete_EmployeeWithGenderAsMaleTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithGenderAsMalePage addEmployeeWithGenderAsMalePage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithGenderAsMalePage = new AddEmployeeWithGenderAsMalePage(wait, driver);
	...
	public void verifyAddEditDeleteEmployeeWithMaleGenderIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithGenderAsMalePage.addEmployeeInputs();
		addEmployeeWithGenderAsMalePage.verifyAddEmployeeSuccessful(addEmployeeWithGenderAsMalePage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithGenderAsMalePage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage
				.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(addEmployeeWithGenderAsMalePage.empIDInput);
