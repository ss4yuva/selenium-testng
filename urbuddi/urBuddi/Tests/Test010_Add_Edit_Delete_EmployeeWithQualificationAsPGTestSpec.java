...
import urBuddi.Pages.AddEmployeeWithQualificationAsPGPage;
...
public class Test010_Add_Edit_Delete_EmployeeWithQualificationAsPGTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithQualificationAsPGPage addEmployeeWithQualificationAsPGPage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithQualificationAsPGPage = new AddEmployeeWithQualificationAsPGPage(wait, driver);
	...
	public void verifyAddEditDeleteEmployeeWithPGQualificationIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithQualificationAsPGPage.addEmployeeInputs();
		addEmployeeWithQualificationAsPGPage
				.verifyAddEmployeeSuccessful(addEmployeeWithQualificationAsPGPage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithQualificationAsPGPage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(
				addEmployeeWithQualificationAsPGPage.empIDInput);
