...
import urBuddi.Pages.AddEmployeeWithGenderAsFemalePage;
...
public class Test013_Add_Edit_Delete_EmployeeWithGenderAsFemaleTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithGenderAsFemalePage addEmployeeWithGenderAsFemalePage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithGenderAsFemalePage = new AddEmployeeWithGenderAsFemalePage(wait, driver);
	...
	@Test
	public void verifyAddEditDeleteEmployeeWithFemaleGenderIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithGenderAsFemalePage.addEmployeeInputs();
		addEmployeeWithGenderAsFemalePage.verifyAddEmployeeSuccessful(addEmployeeWithGenderAsFemalePage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithGenderAsFemalePage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage
				.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(addEmployeeWithGenderAsFemalePage.empIDInput);
