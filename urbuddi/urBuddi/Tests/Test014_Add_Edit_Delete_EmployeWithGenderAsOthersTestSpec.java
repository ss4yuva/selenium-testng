...
import urBuddi.Pages.AddEmployeeWithGenderAsOthersPage;
...
public class Test014_Add_Edit_Delete_EmployeWithGenderAsOthersTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithGenderAsOthersPage addEmployeeWithGenderAsOthersPage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithGenderAsOthersPage = new AddEmployeeWithGenderAsOthersPage(wait, driver);
	...
	@Test
	public void verifyAddEditDeleteEmployeeWithOthersGenderIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithGenderAsOthersPage.addEmployeeInputs();
		addEmployeeWithGenderAsOthersPage.verifyAddEmployeeSuccessful(addEmployeeWithGenderAsOthersPage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithGenderAsOthersPage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage
				.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(addEmployeeWithGenderAsOthersPage.empIDInput);
