...
public class Test004_Add_Edit_Delete_EmployeeWithRoleAsEmployeeTestSpec extends BaseMethods {
	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithRoleAsEmployeePage addEmployeeWithRoleAsEmployeePage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithRoleAsEmployeePage = new AddEmployeeWithRoleAsEmployeePage(wait, driver);
	...
	public void verifyAddEditDeleteEmployeeWithEmployeeRoleIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithRoleAsEmployeePage.addEmployeeInputs();
		addEmployeeWithRoleAsEmployeePage.verifyAddEmployeeSuccessful(addEmployeeWithRoleAsEmployeePage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithRoleAsEmployeePage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage
				.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(addEmployeeWithRoleAsEmployeePage.empIDInput);
