...
import urBuddi.Pages.AddEmployeeWithQualificationsAsOtherPage;
...
public class Test011_Add_Edit_Delete_EmployeeWithQualificationAsOtherTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithQualificationsAsOtherPage addEmployeeWithQualificationAsOtherPage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithQualificationAsOtherPage = new AddEmployeeWithQualificationsAsOtherPage(wait, driver);
	...
	public void verifyAddEditDeleteEmployeeWithOtherQualificationIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithQualificationAsOtherPage.addEmployeeInputs();
		addEmployeeWithQualificationAsOtherPage
				.verifyAddEmployeeSuccessful(addEmployeeWithQualificationAsOtherPage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithQualificationAsOtherPage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(
				addEmployeeWithQualificationAsOtherPage.empIDInput);
