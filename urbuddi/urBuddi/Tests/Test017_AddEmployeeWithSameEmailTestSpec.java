...
import urBuddi.Pages.AddEmployeeWithSameEmailErrorPage;
import urBuddi.Pages.DashBoardEmployeesPage;
import urBuddi.Pages.LoginPage;

public class Test017_AddEmployeeWithSameEmailTestSpec extends BaseMethods {
	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithSameEmailErrorPage addEmployeeWithSameEmailErrorPage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithSameEmailErrorPage = new AddEmployeeWithSameEmailErrorPage(wait, driver);
	}
	...
	public void verifyAddEmployeeIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithSameEmailErrorPage.verifyAddEmployeePage();
		addEmployeeWithSameEmailErrorPage.addEmployeeInputs();
		addEmployeeWithSameEmailErrorPage.verifyErrorMessageIsPresentSuccessful();
