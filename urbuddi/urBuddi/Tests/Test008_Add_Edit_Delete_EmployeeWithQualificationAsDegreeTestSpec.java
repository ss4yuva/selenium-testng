...
public class Test008_Add_Edit_Delete_EmployeeWithQualificationAsDegreeTestSpec extends BaseMethods {

	static WebDriver driver;
	static WebDriverWait wait;
	LoginPage loginPage;
	DashBoardEmployeesPage dashBoardEmployeesPage;
	AddEmployeeWithQualificationAsDegreePage addEmployeeWithQualificationAsDegreePage;
	...
	public void browserLaunch() throws IOException {
		...
		addEmployeeWithQualificationAsDegreePage = new AddEmployeeWithQualificationAsDegreePage(wait, driver);
	...
	public void verifyAddEditDeleteEmployeeWithDegreeQualificationIsSuccessful() throws InterruptedException {
		...
		addEmployeeWithQualificationAsDegreePage.addEmployeeInputs();
		addEmployeeWithQualificationAsDegreePage
				.verifyAddEmployeeSuccessful(addEmployeeWithQualificationAsDegreePage.empIDInput);

		editEmployeePage.searchNewEmployeeWithEmpID(addEmployeeWithQualificationAsDegreePage.empIDInput);
		...
		deleteAddEmployeeAfterEditPage.verifyNewlyAddedEmployeeDelettionIsSuccessfulWithEmpID(
				addEmployeeWithQualificationAsDegreePage.empIDInput);
