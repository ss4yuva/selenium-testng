...
public class TC6DeleteAndVerifyAddEmployeeTNDirectCode {
	...
	public void EnterAddEmployeeInputfields() throws InterruptedException {
		...
		driver.findElement(employeeIDInputfield).sendKeys("OW" + empID);
		...
		driver.findElement(addEmployeeEmailInputfield).sendKeys("test" + empID + "@gmail.com");
		...
		driver.findElement(addEmployeePasswordInputfield).sendKeys("abcd@" + empID);
	...
	public void verifyAddEmployeeSuccessful() {
		System.out.println("Test Priority = 4: Verify Add Employee Successful");

		wait.until(ExpectedConditions.visibilityOfElementLocated(employeeIDSearchField));
		Assert.assertTrue(true, "Employee Added Successful");
		driver.findElement(employeeIDSearchField).click();
		driver.findElement(employeeIDSearchField).sendKeys("OW" + empID);
	...
	@Test(priority = 6)
	public void verifyAddEmployeeAfterDelete() {

		wait.until(ExpectedConditions.visibilityOfElementLocated(employeeIDSearchField));
		Assert.assertTrue(true, "Employee Deleted Successful");
		driver.findElement(employeeIDSearchField).click();
		driver.findElement(employeeIDSearchField).sendKeys("OW" + empID);
