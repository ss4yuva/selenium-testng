...
public class AddEmployeeWithRandomEmailAndPasswordWithRoleEmployeePage {
	...
	public AddEmployeeWithRandomEmailAndPasswordWithRoleEmployeePage(WebDriverWait w, WebDriver d) {
		this.driver = d;
		this.wait = w;
		random = new Random();
