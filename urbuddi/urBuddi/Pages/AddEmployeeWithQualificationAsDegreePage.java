...
public class AddEmployeeWithQualificationAsDegreePage {
	...
	public AddEmployeeWithQualificationAsDegreePage(WebDriverWait w, WebDriver d) {
		this.driver = d;
		this.wait = w;
		random = new Random();
	...
	By qualificationAsDegreeField = By.xpath("//*[text()='Degree']");
