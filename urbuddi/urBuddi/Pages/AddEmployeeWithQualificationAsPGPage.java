...
public class AddEmployeeWithQualificationAsPGPage {
	...
	public AddEmployeeWithQualificationAsPGPage(WebDriverWait w, WebDriver d) {
		this.driver = d;
		this.wait = w;
		random = new Random();
	...
	By qualificationAsPGField = By.xpath("//*[text()='PG']");
