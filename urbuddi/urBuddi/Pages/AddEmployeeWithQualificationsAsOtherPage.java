...
public class AddEmployeeWithQualificationsAsOtherPage {
	...
	public AddEmployeeWithQualificationsAsOtherPage(WebDriverWait w, WebDriver d) {
		this.driver = d;
		this.wait = w;
		random = new Random();
	...
	By qualificationAsOtherField = By.xpath("//*[text()='Other']");
